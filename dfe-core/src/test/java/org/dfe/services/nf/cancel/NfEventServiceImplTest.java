...
class NfEventServiceImplTest {
    ...
    void testCancelWithEnvironmentIsHomologationAndAuthorizerAm() throws Exception {
        ...
        ReturnNfEvent o = service.cancel("22230511520224000140550010000450661287506862", "999999999999999", NFEvent.CANCEL.getDefaultMessage());
        assertNotNull(o);
    ...
    void testCancelWithEnvironmentIsHomologationAndAuthorizerSvan() throws Exception {
        ...
        try {
            ...
            if (o.getRetEvento().isEmpty()) {
                ...
                assertEquals(NFReturnCode.CODE_250.getCode(), o.getRetEvento().getFirst().getInfEvento().getCStat());
                assertEquals(Environment.HOMOLOGATION.getCode(), o.getTpAmb());
            }
