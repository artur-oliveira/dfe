package com.softart.dfe.components.process.cte4.reception_os.impl;

import br.inf.portalfiscal.cte.send400.TCTeOS;
import br.inf.portalfiscal.cte.send400.TRetCTeOS;
import com.softart.dfe.components.process.cte4.reception_os.impl.file.FileSystemCteOsFactory;
import com.softart.dfe.components.process.cte4.reception_os.impl.nostore.NoStoreCteOsFactory;
import com.softart.dfe.components.process.cte4.reception_os.impl.s3.S3StoreCteOsFactory;
