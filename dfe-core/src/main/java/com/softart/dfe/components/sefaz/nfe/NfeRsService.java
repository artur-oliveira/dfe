...
public final class NfeRsService extends NfeAnService {
    ...
    public <T extends SefazRequest<TEnviNFe, TRetEnviNFe>> Pair<TEnviNFe, TRetEnviNFe> authorize(T data) throws SecurityException, ValidationException, ProcessException {
        ...
        if (data.config().production()) {
            ...
            br.inf.portalfiscal.nfe.wsdl.authorization.rs.prod.NfeResultMsg resultMsg = ws.nfeAutorizacaoLoteZip(gzip);
            ...
            br.inf.portalfiscal.nfe.wsdl.authorization.rs.hom.NfeResultMsg resultMsg = ws.nfeAutorizacaoLoteZip(gzip);
