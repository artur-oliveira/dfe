...
public final class NfceMgSoapService extends AbstractNfceSoapService {

    public NfceMgSoapService() {
    }

    public NfceMgSoapService(NfConfig config) {
        super(config);
    }

    @Override
    public NfceAuthorizer getAuthorizer() {
        return NfceAuthorizer.MG;
    }
}
