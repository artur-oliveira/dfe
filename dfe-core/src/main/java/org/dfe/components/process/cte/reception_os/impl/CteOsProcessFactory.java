package org.dfe.components.process.cte.reception_os.impl;

import br.inf.portalfiscal.cte.send.TCTeOS;
import br.inf.portalfiscal.cte.send.TRetCTeOS;
import org.dfe.components.process.cte.reception_os.impl.file.FileSystemCteOsFactory;
import org.dfe.components.process.cte.reception_os.impl.nostore.NoStoreCteOsFactory;
import org.dfe.components.process.cte.reception_os.impl.s3.S3StoreCteOsFactory;
