package org.dfe.components.process.cte4.query_situation.impl;

import br.inf.portalfiscal.cte.send400.TConsSitCTe;
import br.inf.portalfiscal.cte.send400.TRetConsSitCTe;
import org.dfe.components.process.cte4.query_situation.impl.file.FileSystemQuerySituationCteFactory;
import org.dfe.components.process.cte4.query_situation.impl.nostore.NoStoreQuerySituationCteFactory;
import org.dfe.components.process.cte4.query_situation.impl.s3.S3StoreQuerySituationCteFactory;
