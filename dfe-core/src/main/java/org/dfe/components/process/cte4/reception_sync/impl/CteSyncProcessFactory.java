package org.dfe.components.process.cte4.reception_sync.impl;

import br.inf.portalfiscal.cte.send400.TCTe;
import br.inf.portalfiscal.cte.send400.TRetCTe;
import org.dfe.components.process.cte4.reception_sync.impl.file.FileSystemCteFactory;
import org.dfe.components.process.cte4.reception_sync.impl.nostore.NoStoreCteFactory;
import org.dfe.components.process.cte4.reception_sync.impl.s3.S3StoreCteFactory;
