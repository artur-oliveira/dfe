package org.dfe.components.process.nf.return_authorization.impl;

import br.inf.portalfiscal.nfe.send.TConsReciNFe;
import br.inf.portalfiscal.nfe.send.TRetConsReciNFe;
import org.dfe.components.process.nf.return_authorization.impl.file.FileStoreFactory;
import org.dfe.components.process.nf.return_authorization.impl.nostore.NoStoreFactory;
import org.dfe.components.process.nf.return_authorization.impl.s3.S3StoreFactory;
