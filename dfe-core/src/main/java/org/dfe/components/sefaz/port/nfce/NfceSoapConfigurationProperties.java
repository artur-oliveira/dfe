...
public final class NfceSoapConfigurationProperties {
    ...
    public static final boolean CACHE_HOM_EVENT = Boolean.parseBoolean(System.getProperty("org.dfe.soap.nfce.cache.hom-event", "false"));
    ...
    public static final boolean CACHE_PROD_EVENT = Boolean.parseBoolean(System.getProperty("org.dfe.soap.nfce.cache.prod-event", "false"));
