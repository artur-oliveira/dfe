...
import org.dfe.interfaces.security.CertificateChainCache;

public abstract class CertificateChainCacheFactory implements CertificateChainCache {

    protected static final long DAYS_IN_CACHE = Long.parseLong(System.getProperty("org.dfe.security.chain.cache.days", "14"));
    private static final String DEFAULT_CERTIFICATE_CHAIN_CACHE = System.getProperty("org.dfe.chain.cache", "filesystem");
