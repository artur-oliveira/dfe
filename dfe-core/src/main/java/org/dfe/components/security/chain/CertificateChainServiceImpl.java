...
final class CertificateChainServiceImpl extends CertificateChainFactory {
    ...
    private static final String DEFAULT_PASSWORD = System.getProperty("org.dfe.security.chain.password", "123456");
    private static final int PORT = 443;
    private static final String PROTOCOL = "TLSv1.2";
    private static final int SOCKET_TIMEOUT = Math.min(Integer.parseInt(System.getProperty("org.dfe.security.chain.socket.timeout", "2000")), 2000);
