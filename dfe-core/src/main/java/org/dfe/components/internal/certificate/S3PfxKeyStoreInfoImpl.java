...
public final class S3PfxKeyStoreInfoImpl extends PfxKeyStoreInfoImpl {
    ...
    public S3PfxKeyStoreInfoImpl(String bucket, String key, String certificatePassword) throws CertificateException {
        super(S3Utils.getObject(bucket, key).asInputStream(), certificatePassword);
    }
    ...
    public S3PfxKeyStoreInfoImpl(String bucket, String key, String certificatePassword, final byte[] certificateChain, final String certificateChainPassword) throws CertificateException {
        super(S3Utils.getObject(bucket, key).asInputStream(), certificatePassword, certificateChain, certificateChainPassword);
    }
