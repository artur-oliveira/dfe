...
public final class DynamoNfceQueryUrl implements NfceQueryUrl {

    private static final String DYNAMO_DB_TABLE = Optional.ofNullable(System.getenv("org.dfe.nfce.query-url-table")).orElse(System.getProperty("org.dfe.nfce.query-url-table", "dfe_uf_urls"));
    private static final Function<Map<String, AttributeValue>, NfceQueryUrlDynamo> TRANSFORMER = attr -> NfceQueryUrlDynamo
            ...
            .urlProd(attr.get("query_nfce_prod").s())
            .urlHom(attr.get("query_nfce_hom").s())
            .build();
