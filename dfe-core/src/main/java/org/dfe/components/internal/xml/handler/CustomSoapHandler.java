...
public final class CustomSoapHandler implements SOAPHandler<SOAPMessageContext> {
    ...
    private static final boolean LOG_REQUEST = Boolean.parseBoolean(System.getProperty("org.dfe.handler.log.request", "true"));
    private static final boolean LOG_RESPONSE = Boolean.parseBoolean(System.getProperty("org.dfe.handler.log.response", "true"));
