 ...
 *
 */
@WebServiceClient(name = "NfeRetAutorizacao4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRetAutorizacao4", wsdlLocation = "https://homologacao.sefaz.mt.gov.br/nfews/v2/services/NfeRetAutorizacao4?wsdl")
public class NfeRetAutorizacao4
    ...
    static {
        ...
        try {
            url = URI.create("https://homologacao.sefaz.mt.gov.br/nfews/v2/services/NfeRetAutorizacao4?wsdl").toURL();
