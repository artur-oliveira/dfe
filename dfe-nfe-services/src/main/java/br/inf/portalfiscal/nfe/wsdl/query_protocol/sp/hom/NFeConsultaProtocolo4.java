 ...
 * solicitações de consulta da situação atual da NF-e na Base de Dados do Portal da Secretaria de Fazenda
 * Estadual.
 * <p>
 * <p>
 ...
 *
 */
@WebServiceClient(name = "NFeConsultaProtocolo4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeConsultaProtocolo4", wsdlLocation = "https://homologacao.nfe.fazenda.sp.gov.br/ws/nfeconsultaprotocolo4.asmx?wsdl")
public class NFeConsultaProtocolo4
    ...
    static {
        ...
        try {
            url = URI.create("https://homologacao.nfe.fazenda.sp.gov.br/ws/nfeconsultaprotocolo4.asmx?wsdl").toURL();
