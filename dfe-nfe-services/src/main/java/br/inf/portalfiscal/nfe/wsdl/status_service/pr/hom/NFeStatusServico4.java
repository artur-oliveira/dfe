 ...
 *
 */
@WebServiceClient(name = "NFeStatusServico4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeStatusServico4", wsdlLocation = "https://homologacao.nfe.sefa.pr.gov.br/nfe/NFeStatusServico4?wsdl")
public class NFeStatusServico4
    ...
    static {
        ...
        try {
            url = URI.create("https://homologacao.nfe.sefa.pr.gov.br/nfe/NFeStatusServico4?wsdl").toURL();
