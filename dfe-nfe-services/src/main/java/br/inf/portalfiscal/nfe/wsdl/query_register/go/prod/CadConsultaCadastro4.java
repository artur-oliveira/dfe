 ...
 *
 */
@WebServiceClient(name = "CadConsultaCadastro4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro4", wsdlLocation = "https://nfe.sefaz.go.gov.br/nfe/services/CadConsultaCadastro4?wsdl")
public class CadConsultaCadastro4
    ...
    static {
        ...
        try {
            url = URI.create("https://nfe.sefaz.go.gov.br/nfe/services/CadConsultaCadastro4?wsdl").toURL();
