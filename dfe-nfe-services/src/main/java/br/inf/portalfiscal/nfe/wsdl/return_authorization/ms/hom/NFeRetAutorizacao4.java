 ...
 *
 */
@WebServiceClient(name = "NFeRetAutorizacao4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRetAutorizacao4", wsdlLocation = "https://hom.nfe.sefaz.ms.gov.br/ws/NFeRetAutorizacao4?wsdl")
public class NFeRetAutorizacao4
    ...
    static {
        ...
        try {
            url = URI.create("https://hom.nfe.sefaz.ms.gov.br/ws/NFeRetAutorizacao4?wsdl").toURL();
