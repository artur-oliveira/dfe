 ...
 *
 */
@WebServiceClient(name = "NFeStatusServico4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeStatusServico4", wsdlLocation = "https://hom.nfe.sefaz.ms.gov.br/ws/NFeStatusServico4?wsdl")
public class NFeStatusServico4_Service
    ...
    static {
        ...
        try {
            url = URI.create("https://hom.nfe.sefaz.ms.gov.br/ws/NFeStatusServico4?wsdl").toURL();
