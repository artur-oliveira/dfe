 ...
 *
 */
@WebServiceClient(name = "CadConsultaCadastro4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro4", wsdlLocation = "https://nfe.fazenda.sp.gov.br/ws/cadconsultacadastro4.asmx?wsdl")
public class CadConsultaCadastro4
    ...
    static {
        ...
        try {
            url = URI.create("https://nfe.fazenda.sp.gov.br/ws/cadconsultacadastro4.asmx?wsdl").toURL();
