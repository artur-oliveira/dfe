 ...
 */
@WebServiceClient(name = "RecepcaoEvento4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRecepcaoEvento4", wsdlLocation = "https://homnfe.sefaz.am.gov.br/services2/services/RecepcaoEvento4?wsdl")
public class RecepcaoEvento4
    ...
    static {
        ...
        try {
            url = new URL("https://homnfe.sefaz.am.gov.br/services2/services/RecepcaoEvento4?wsdl");
