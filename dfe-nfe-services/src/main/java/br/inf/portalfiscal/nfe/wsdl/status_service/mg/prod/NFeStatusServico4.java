 ...
 *
 */
@WebServiceClient(name = "NFeStatusServico4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeStatusServico4", wsdlLocation = "https://nfe.fazenda.mg.gov.br/nfe2/services/NFeStatusServico4?wsdl")
public class NFeStatusServico4
    ...
    static {
        ...
        try {
            url = URI.create("https://nfe.fazenda.mg.gov.br/nfe2/services/NFeStatusServico4?wsdl").toURL();
