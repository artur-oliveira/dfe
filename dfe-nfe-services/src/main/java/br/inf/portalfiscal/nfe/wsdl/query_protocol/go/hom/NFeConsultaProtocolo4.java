 ...
 *
 */
@WebServiceClient(name = "NFeConsultaProtocolo4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeConsultaProtocolo4", wsdlLocation = "https://homolog.sefaz.go.gov.br/nfe/services/NFeConsultaProtocolo4?wsdl")
public class NFeConsultaProtocolo4
    ...
    static {
        ...
        try {
            url = URI.create("https://homolog.sefaz.go.gov.br/nfe/services/NFeConsultaProtocolo4?wsdl").toURL();
