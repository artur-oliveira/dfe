 ...
 *
 */
@WebServiceClient(name = "NFeRetAutorizacao4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRetAutorizacao4", wsdlLocation = "https://hnfe.fazenda.mg.gov.br/nfe2/services/NFeRetAutorizacao4?wsdl")
public class NFeRetAutorizacao4
    ...
    static {
        ...
        try {
            url = URI.create("https://hnfe.fazenda.mg.gov.br/nfe2/services/NFeRetAutorizacao4?wsdl").toURL();
