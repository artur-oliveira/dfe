 ...
 *
 */
@WebServiceClient(name = "NFeStatusServico4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeStatusServico4", wsdlLocation = "https://nfe.fazenda.sp.gov.br/ws/nfestatusservico4.asmx?wsdl")
public class NFeStatusServico4
    ...
    static {
        ...
        try {
            url = URI.create("https://nfe.fazenda.sp.gov.br/ws/nfestatusservico4.asmx?wsdl").toURL();
