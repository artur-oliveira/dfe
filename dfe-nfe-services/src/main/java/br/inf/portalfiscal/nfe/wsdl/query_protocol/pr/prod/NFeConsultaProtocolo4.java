 ...
 * solicitacoes de consulta da situacao atual da NFe na Base de Dados do Portal da Secretaria de Fazenda
 * Estadual
 * <p>
 * <p>
...
public class NFeConsultaProtocolo4
    ...
    static {
        ...
        try {
            url = URI.create("https://nfe.sefa.pr.gov.br/nfe/NFeConsultaProtocolo4?wsdl").toURL();
