 ...
 *
 */
@WebServiceClient(name = "NfeConsulta4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeConsultaProtocolo4", wsdlLocation = "https://homologacao.sefaz.mt.gov.br/nfews/v2/services/NfeConsulta4?wsdl")
public class NfeConsulta4
    ...
    static {
        ...
        try {
            url = URI.create("https://homologacao.sefaz.mt.gov.br/nfews/v2/services/NfeConsulta4?wsdl").toURL();
