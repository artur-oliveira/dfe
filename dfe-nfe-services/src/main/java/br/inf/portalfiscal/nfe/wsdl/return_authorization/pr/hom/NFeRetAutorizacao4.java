 ...
 *
 */
@WebServiceClient(name = "NFeRetAutorizacao4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRetAutorizacao4", wsdlLocation = "https://homologacao.nfe.sefa.pr.gov.br/nfe/NFeRetAutorizacao4?wsdl")
public class NFeRetAutorizacao4
    ...
    static {
        ...
        try {
            url = URI.create("https://homologacao.nfe.sefa.pr.gov.br/nfe/NFeRetAutorizacao4?wsdl").toURL();
