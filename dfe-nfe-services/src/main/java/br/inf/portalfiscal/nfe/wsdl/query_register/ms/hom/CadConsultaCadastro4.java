 ...
 *
 */
@WebServiceClient(name = "CadConsultaCadastro4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro4", wsdlLocation = "https://hom.nfe.sefaz.ms.gov.br/ws/CadConsultaCadastro4?wsdl")
public class CadConsultaCadastro4
    ...
    static {
        ...
        try {
            url = URI.create("https://hom.nfe.sefaz.ms.gov.br/ws/CadConsultaCadastro4?wsdl").toURL();
