 ...
 *             solicitacoes de consulta da situacao atual da NFCe na Base de Dados do Portal da Secretaria de Fazenda
 *             Estadual.
 *         
 * 
 ...
 * 
 */
@WebServiceClient(name = "NFeConsultaProtocolo4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeConsultaProtocolo4", wsdlLocation = "https://homologacao.nfce.sefa.pr.gov.br/nfce/NFeConsultaProtocolo4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = URI.create("https://homologacao.nfce.sefa.pr.gov.br/nfce/NFeConsultaProtocolo4?wsdl").toURL();
