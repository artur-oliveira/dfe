 ...
 * 
 */
@WebServiceClient(name = "NFeStatusServico4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeStatusServico4", wsdlLocation = "https://nfce.sefaz.ms.gov.br/ws/NFeStatusServico4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = URI.create("https://nfce.sefaz.ms.gov.br/ws/NFeStatusServico4?wsdl").toURL();
