 ...
 * 
 */
@WebServiceClient(name = "NFeStatusServico4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeStatusServico4", wsdlLocation = "https://hom.nfce.sefaz.ms.gov.br/ws/NFeStatusServico4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = URI.create("https://hom.nfce.sefaz.ms.gov.br/ws/NFeStatusServico4?wsdl").toURL();
