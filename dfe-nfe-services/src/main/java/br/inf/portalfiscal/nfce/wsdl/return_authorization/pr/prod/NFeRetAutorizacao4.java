 ...
 * 
 */
@WebServiceClient(name = "NFeRetAutorizacao4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRetAutorizacao4", wsdlLocation = "https://nfce.sefa.pr.gov.br/nfce/NFeRetAutorizacao4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = URI.create("https://nfce.sefa.pr.gov.br/nfce/NFeRetAutorizacao4?wsdl").toURL();
