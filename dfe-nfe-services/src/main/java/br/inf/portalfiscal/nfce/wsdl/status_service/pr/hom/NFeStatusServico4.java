 ...
 * 
 */
@WebServiceClient(name = "NFeStatusServico4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeStatusServico4", wsdlLocation = "https://homologacao.nfce.sefa.pr.gov.br/nfce/NFeStatusServico4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = URI.create("https://homologacao.nfce.sefa.pr.gov.br/nfce/NFeStatusServico4?wsdl").toURL();
