 ...
 * 
 */
@WebServiceClient(name = "NfeRetAutorizacao4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRetAutorizacao4", wsdlLocation = "https://homologacao.sefaz.mt.gov.br/nfcews/services/NfeRetAutorizacao4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = URI.create("https://homologacao.sefaz.mt.gov.br/nfcews/services/NfeRetAutorizacao4?wsdl").toURL();
