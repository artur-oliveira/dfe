...
public enum CteEvent implements DFEnum.Codeable {
    ...
    CANCEL("110111", "Cancelamento", System.getProperty("com.softart.dfe.cte.message.cancel", "erro de emissao"), "evCancCTe_v{{VERSION}}.xsd"),
    ...
    EPEC("110113", "EPEC", System.getProperty("com.softart.dfe.cte.message.epec", "erro no autorizador de origem"), "evEPECCTe_v{{VERSION}}.xsd"),
