...
public interface NfEvent {
     ...
     */
    <T extends SefazRequest<TEnvEvento, TRetEnvEvento>> Pair<TEnvEvento, TRetEnvEvento> event(T data) throws SecurityException, ValidationException, ProcessException;
