...
public final class CteOs implements DFObject, XMLAdapter<CteOs, TCTeOS> {
    ...
    public final static class InfCte implements DFObject, XMLAdapter<InfCte, TCTeOS.InfCte> {
        ...
        public final static class Imp implements DFObject, XMLAdapter<Imp, TCTeOS.InfCte.Imp> {
            ...
            @Data
            @Builder
            public final static class TImpOS implements DFObject, XMLAdapter<TImpOS, br.inf.portalfiscal.cte.send400.TImpOS> {
                ...
                @AllArgsConstructor
                @NoArgsConstructor
                public final static class ICMS00 implements DFObject, XMLAdapter<ICMS00, br.inf.portalfiscal.cte.send400.TImpOS.ICMS00> {
                ...
                @AllArgsConstructor
                @NoArgsConstructor
                public final static class ICMS20 implements DFObject, XMLAdapter<ICMS20, br.inf.portalfiscal.cte.send400.TImpOS.ICMS20> {
                    @Builder.Default
                ...
                @AllArgsConstructor
                @NoArgsConstructor
                public final static class ICMS45 implements DFObject, XMLAdapter<ICMS45, br.inf.portalfiscal.cte.send400.TImpOS.ICMS45> {
                    private String cst;
                }
                ...
                @AllArgsConstructor
                @NoArgsConstructor
                public final static class ICMS90 implements DFObject, XMLAdapter<ICMS90, br.inf.portalfiscal.cte.send400.TImpOS.ICMS90> {
                    @Builder.Default
                ...
                @AllArgsConstructor
                @NoArgsConstructor
                public final static class ICMSOutraUF implements DFObject, XMLAdapter<ICMSOutraUF, br.inf.portalfiscal.cte.send400.TImpOS.ICMSOutraUF> {
                    @Builder.Default
                ...
                @AllArgsConstructor
                @NoArgsConstructor
                public final static class ICMSSN implements DFObject, XMLAdapter<ICMSSN, br.inf.portalfiscal.cte.send400.TImpOS.ICMSSN> {
                    @Builder.Default
        ...
        public final static class InfCTeNorm implements DFObject, XMLAdapter<InfCTeNorm, TCTeOS.InfCte.InfCTeNorm> {
            ...
            public final static class InfModal implements DFObject, XMLAdapter<InfModal, TCTeOS.InfCte.InfCTeNorm.InfModal> {
                ...
                public InfModal fromObject(TCTeOS.InfCte.InfCTeNorm.InfModal o) {
                    ...
                    if (el instanceof br.inf.portalfiscal.cte.send400.RodoOS) {
                        setRodoOs(RodoOS.builder().build().fromObject((br.inf.portalfiscal.cte.send400.RodoOS) el));
                    }
                ...
                @Data
                @Builder
                public final static class RodoOS implements DFObject, XMLAdapter<RodoOS, br.inf.portalfiscal.cte.send400.RodoOS> {
                    private String taf;
                    ...
                    @Data
                    @Builder
                    public final static class Veic implements DFObject, XMLAdapter<Veic, br.inf.portalfiscal.cte.send400.RodoOS.Veic> {
                        ...
                        @Data
                        @Builder
                        public final static class Prop implements DFObject, XMLAdapter<Prop, br.inf.portalfiscal.cte.send400.RodoOS.Veic.Prop> {
                            private String cpf;
                            private String cnpj;
                            private String taf;
                            private String nroRegEstadual;
                    ...
                    @Data
                    @Builder
                    public final static class InfFretamento implements DFObject, XMLAdapter<InfFretamento, br.inf.portalfiscal.cte.send400.RodoOS.InfFretamento> {
