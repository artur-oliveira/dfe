...
public final class CteDeliveryReceipt implements DFObject, XMLAdapter<CteDeliveryReceipt, TEvento> {
    ...
    public static final class InfEvento implements DFObject, XMLAdapter<InfEvento, TEvento.InfEvento> {
        ...
        public static final class DetEvento implements DFObject, XMLAdapter<DetEvento, br.inf.portalfiscal.cte.send400.TEvento.InfEvento.DetEvento> {
            ...
            @NoArgsConstructor
            @Builder
            public static final class EvCECTe implements DFObject, XMLAdapter<EvCECTe, br.inf.portalfiscal.cte.send400.EvCECTe> {
                @Builder.Default
                ...
                @NoArgsConstructor
                @Builder
                public static final class InfEntrega implements DFObject, XMLAdapter<InfEntrega, br.inf.portalfiscal.cte.send400.EvCECTe.InfEntrega> {
