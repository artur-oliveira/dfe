...
public interface MdfeReceptionService extends MdfeSefazService {
     ...
     */
    default SendMdfeReturn reception(TEnviMDFe tEnviMDFe) throws CircuitBreakerException, NoProviderFound, SecurityException, ProcessException, ValidationException, SoapServiceGeneralException {
        ...
        Pair<?, TRetEnviMDFe> res = getCircuitBreakerRegistry().get(
                config.environment(),
                Model.MDFE,
                config.webServiceUF(),
                DfeOperation.AUTHORIZATION
        ).execute(() -> service.reception(MdfeRequest
                .builder()
                .data(tEnviMDFe)
                .signer(getXmlSigner())
                .config(config)
                ...
                .build()));
        return new SendMdfeReturn().fromObject(res);
    }
     ...
     */
    default SendMdfeReturn reception(SendMdfe sendMdfe) throws CircuitBreakerException, NoProviderFound, SecurityException, ProcessException, ValidationException, SoapServiceGeneralException {
     ...
     */
    default SendMdfeReturn reception(Mdfe tmdFe) throws CircuitBreakerException, NoProviderFound, SecurityException, ProcessException, ValidationException, SoapServiceGeneralException {
     ...
     */
    default SendMdfeReturn reception(String xml) throws CircuitBreakerException, NoProviderFound, SecurityException, ProcessException, ValidationException, SoapServiceGeneralException {
