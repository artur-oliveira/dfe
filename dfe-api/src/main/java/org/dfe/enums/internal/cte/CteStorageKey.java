...
public enum CteStorageKey implements StorageKey {
    ...
    CTE_QUERY_RECEIPT(System.getProperty("org.dfe.storage.key.cte.query_receipt", ObjectFactory._ConsReciCTe_QNAME.getLocalPart()), System.getProperty("org.dfe.storage.key.cte.return_query_receipt", ObjectFactory._RetConsReciCTe_QNAME.getLocalPart()), null),
    ...
    CTE_RECEPTION(System.getProperty("org.dfe.storage.key.cte.reception", ObjectFactory._EnviCTe_QNAME.getLocalPart()), System.getProperty("org.dfe.storage.key.cte.return_reception", ObjectFactory._RetEnviCte_QNAME.getLocalPart()), System.getProperty("org.dfe.storage.key.cte.proc", ObjectFactory._CteProc_QNAME.getLocalPart())),
