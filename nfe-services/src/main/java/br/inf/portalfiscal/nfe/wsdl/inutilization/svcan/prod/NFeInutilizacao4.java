 ...
 * 
 */
@WebServiceClient(name = "NFeInutilizacao4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeInutilizacao4", wsdlLocation = "https://www.svc.fazenda.gov.br/NFeInutilizacao4/NFeInutilizacao4.asmx?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://www.svc.fazenda.gov.br/NFeInutilizacao4/NFeInutilizacao4.asmx?wsdl");
