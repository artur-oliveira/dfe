 ...
 */
@WebServiceClient(name = "NFeRetAutorizacao4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRetAutorizacao4", wsdlLocation = "https://nfce.sefaz.ms.gov.br/ws/NFeRetAutorizacao4?wsdl")
public class NFeRetAutorizacao4
    ...
    static {
        ...
        try {
            url = new URL("https://nfce.sefaz.ms.gov.br/ws/NFeRetAutorizacao4?wsdl");
