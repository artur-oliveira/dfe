 ...
 */
@WebServiceClient(name = "NFeStatusServico4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeStatusServico4", wsdlLocation = "https://nfce.sefa.pr.gov.br/nfce/NFeStatusServico4?wsdl")
public class NFeStatusServico4
    ...
    static {
        ...
        try {
            url = new URL("https://nfce.sefa.pr.gov.br/nfce/NFeStatusServico4?wsdl");
