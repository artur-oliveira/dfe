...
@XmlSeeAlso({
        ObjectFactory.class, br.inf.portalfiscal.nfe.event_manifestation.ObjectFactory.class
})
public interface NFeRecepcaoEvento4Soap {
    ...
    /**
     * @param nfeDadosMsg
     * @return returns br.inf.portalfiscal.nfe.wsdl.event_manifestation.an.prod.NfeRecepcaoEventoNFResult
     */
