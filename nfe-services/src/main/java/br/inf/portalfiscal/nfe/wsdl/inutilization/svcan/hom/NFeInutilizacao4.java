 ...
 * 
 */
@WebServiceClient(name = "NFeInutilizacao4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeInutilizacao4", wsdlLocation = "https://hom.svc.fazenda.gov.br/NFeInutilizacao4/NFeInutilizacao4.asmx?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://hom.svc.fazenda.gov.br/NFeInutilizacao4/NFeInutilizacao4.asmx?wsdl");
