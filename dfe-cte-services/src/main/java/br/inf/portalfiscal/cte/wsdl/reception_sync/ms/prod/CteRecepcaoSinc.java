 ...
 */
@WebServiceClient(name = "CteRecepcaoSinc", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoSinc", wsdlLocation = "https://producao.cte.ms.gov.br/ws/CteRecepcaoSinc?wsdl")
public class CteRecepcaoSinc
    ...
    static {
        ...
        try {
            url = new URL("https://producao.cte.ms.gov.br/ws/CteRecepcaoSinc?wsdl");
