 ...
 */
@WebServiceClient(name = "CteRecepcaoOS", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoOS", wsdlLocation = "https://producao.cte.ms.gov.br/ws/CteRecepcaoOS?wsdl")
public class CteRecepcaoOS
    ...
    static {
        ...
        try {
            url = new URL("https://producao.cte.ms.gov.br/ws/CteRecepcaoOS?wsdl");
