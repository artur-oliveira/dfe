package br.inf.portalfiscal.cte.wsdl.reception_sync.pr.prod;
 ...
 * generated in the br.inf.portalfiscal.cte.wsdl.reception_sync.pr.prod package.
...
public class ObjectFactory {
    ...
    private static final QName _CteCabecMsg_QNAME = new QName("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoSinc", "cteCabecMsg");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.inf.portalfiscal.cte.wsdl.reception_sync.pr.prod
     */
     ...
     *
     * @return the new instance of {@link CteRecepcaoResult }
     */
     ...
     */
    @XmlElementDecl(namespace = "http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoSinc", name = "cteCabecMsg")
