 ...
 */
@WebServiceClient(name = "CteRecepcaoSinc", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoSinc", wsdlLocation = "https://cte.sefaz.mt.gov.br/ctews2/services/CteRecepcaoSinc?wsdl")
public class CteRecepcaoSinc
    ...
    static {
        ...
        try {
            url = new URL("https://cte.sefaz.mt.gov.br/ctews2/services/CteRecepcaoSinc?wsdl");
