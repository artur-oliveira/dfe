 ...
 */
@WebServiceClient(name = "CteRecepcaoEvento", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoEvento", wsdlLocation = "https://homologacao.cte.fazenda.pr.gov.br/cte/CteRecepcaoEvento?wsdl")
public class CteRecepcaoEvento
    ...
    static {
        ...
        try {
            url = new URL("https://homologacao.cte.fazenda.pr.gov.br/cte/CteRecepcaoEvento?wsdl");
