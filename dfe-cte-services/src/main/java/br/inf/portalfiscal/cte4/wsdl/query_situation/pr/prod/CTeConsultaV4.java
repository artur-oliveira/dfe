 ...
 *
 */
@WebServiceClient(name = "CTeConsultaV4", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CTeConsultaV4", wsdlLocation = "https://cte.fazenda.pr.gov.br/cte4/CTeConsultaV4?wsdl")
public class CTeConsultaV4
    ...
    static {
        ...
        try {
            url = URI.create("https://cte.fazenda.pr.gov.br/cte4/CTeConsultaV4?wsdl").toURL();
