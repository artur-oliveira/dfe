 ...
 *
 */
@WebServiceClient(name = "CTeRecepcaoGTVeV4", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CTeRecepcaoGTVeV4", wsdlLocation = "https://cte.fazenda.mg.gov.br/cte/services/CTeRecepcaoGTVeV4?wsdl")
public class CTeRecepcaoGTVeV4
    ...
    static {
        ...
        try {
            url = URI.create("https://cte.fazenda.mg.gov.br/cte/services/CTeRecepcaoGTVeV4?wsdl").toURL();
