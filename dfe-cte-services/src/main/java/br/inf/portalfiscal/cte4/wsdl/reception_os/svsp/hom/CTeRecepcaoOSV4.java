 ...
 *
 */
@WebServiceClient(name = "CTeRecepcaoOSV4", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CTeRecepcaoOSV4", wsdlLocation = "https://homologacao.nfe.fazenda.sp.gov.br/CTeWS/WS/CTeRecepcaoOSV4.asmx?wsdl")
public class CTeRecepcaoOSV4
    ...
    static {
        ...
        try {
            url = URI.create("https://homologacao.nfe.fazenda.sp.gov.br/CTeWS/WS/CTeRecepcaoOSV4.asmx?wsdl").toURL();
