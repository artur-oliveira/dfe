 ...
 *
 */
@WebServiceClient(name = "CTeRecepcaoSincV4", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CTeRecepcaoSincV4", wsdlLocation = "https://cte.fazenda.mg.gov.br/cte/services/CTeRecepcaoSincV4?wsdl")
public class CTeRecepcaoSincV4
    ...
    static {
        ...
        try {
            url = URI.create("https://cte.fazenda.mg.gov.br/cte/services/CTeRecepcaoSincV4?wsdl").toURL();
