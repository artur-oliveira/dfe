 ...
 * 
 */
@WebServiceClient(name = "CTeRecepcaoSincV4", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CTeRecepcaoSincV4", wsdlLocation = "https://homologacao.sefaz.mt.gov.br/ctews2/services/CTeRecepcaoSincV4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = URI.create("https://homologacao.sefaz.mt.gov.br/ctews2/services/CTeRecepcaoSincV4?wsdl").toURL();
