 ...
 */
@WebServiceClient(name = "CTeConsultaV4", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CTeConsultaV4", wsdlLocation = "https://homologacao.sefaz.mt.gov.br/ctews2/services/CTeConsultaV4?wsdl")
public class CTeConsultaV4
    ...
    static {
        ...
        try {
            url = new URL("https://homologacao.sefaz.mt.gov.br/ctews2/services/CTeConsultaV4?wsdl");
