 ...
 *
 */
@WebServiceClient(name = "CTeRecepcaoEventoV4", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CTeRecepcaoEventoV4", wsdlLocation = "https://cte.fazenda.mg.gov.br/cte/services/CTeRecepcaoEventoV4?wsdl")
public class CTeRecepcaoEventoV4
    ...
    static {
        ...
        try {
            url = URI.create("https://cte.fazenda.mg.gov.br/cte/services/CTeRecepcaoEventoV4?wsdl").toURL();
