 ...
 *
 */
@WebServiceClient(name = "CTeConsultaV4", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CTeConsultaV4", wsdlLocation = "https://hcte.fazenda.mg.gov.br/cte/services/CTeConsultaV4?wsdl")
public class CTeConsultaV4
    ...
    static {
        ...
        try {
            url = URI.create("https://hcte.fazenda.mg.gov.br/cte/services/CTeConsultaV4?wsdl").toURL();
