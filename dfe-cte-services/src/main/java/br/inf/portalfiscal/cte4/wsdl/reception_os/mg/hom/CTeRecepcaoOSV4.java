 ...
 *
 */
@WebServiceClient(name = "CTeRecepcaoOSV4", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CTeRecepcaoOSV4", wsdlLocation = "https://hcte.fazenda.mg.gov.br/cte/services/CTeRecepcaoOSV4?wsdl")
public class CTeRecepcaoOSV4
    ...
    static {
        ...
        try {
            url = URI.create("https://hcte.fazenda.mg.gov.br/cte/services/CTeRecepcaoOSV4?wsdl").toURL();
