 ...
 *
 */
@WebServiceClient(name = "CTeRecepcaoOSV4", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CTeRecepcaoOSV4", wsdlLocation = "https://homologacao.cte.fazenda.pr.gov.br/cte4/CTeRecepcaoOSV4?wsdl")
public class CTeRecepcaoOSV4
    ...
    static {
        ...
        try {
            url = URI.create("https://homologacao.cte.fazenda.pr.gov.br/cte4/CTeRecepcaoOSV4?wsdl").toURL();
