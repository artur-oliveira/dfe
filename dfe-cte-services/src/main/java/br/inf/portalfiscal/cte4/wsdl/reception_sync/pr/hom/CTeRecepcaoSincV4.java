 ...
 *
 */
@WebServiceClient(name = "CTeRecepcaoSincV4", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CTeRecepcaoSincV4", wsdlLocation = "https://homologacao.cte.fazenda.pr.gov.br/cte4/CTeRecepcaoSincV4?wsdl")
public class CTeRecepcaoSincV4
    ...
    static {
        ...
        try {
            url = URI.create("https://homologacao.cte.fazenda.pr.gov.br/cte4/CTeRecepcaoSincV4?wsdl").toURL();
