 ...
 * 
 */
@WebServiceClient(name = "CTeRecepcaoOSV4", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CTeRecepcaoOSV4", wsdlLocation = "https://homologacao.sefaz.mt.gov.br/ctews/services/CTeRecepcaoOSV4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = URI.create("https://homologacao.sefaz.mt.gov.br/ctews/services/CTeRecepcaoOSV4?wsdl").toURL();
