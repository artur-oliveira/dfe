 ...
 *
 */
@WebServiceClient(name = "CTeConsultaV4", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CTeConsultaV4", wsdlLocation = "https://homologacao.cte.ms.gov.br/ws/CTeConsultaV4?wsdl")
public class CTeConsultaV4
    ...
    static {
        ...
        try {
            url = URI.create("https://homologacao.cte.ms.gov.br/ws/CTeConsultaV4?wsdl").toURL();
