 ...
 *
 */
@WebServiceClient(name = "CTeRecepcaoOSV4Service", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CTeRecepcaoOSV4", wsdlLocation = "https://producao.cte.ms.gov.br/ws/CTeRecepcaoOSV4?wsdl")
public class CTeRecepcaoOSV4Service
    ...
    static {
        ...
        try {
            url = URI.create("https://producao.cte.ms.gov.br/ws/CTeRecepcaoOSV4?wsdl").toURL();
