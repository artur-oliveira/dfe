 ...
 *           &lt;/complexType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="procInfraSA" minOccurs="0"&gt;
 *           &lt;complexType&gt;
 *             &lt;complexContent&gt;
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="nProtDTe" type="{http://www.portalfiscal.inf.br/mdfe}TProt"/&gt;
 *                   &lt;element name="dhProt" type="{http://www.portalfiscal.inf.br/mdfe}TDateTimeUTC"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
public class TRetConsSitMDFe
    ...
    protected ProcInfraSA procInfraSA;
    ...
    /**
     * Gets the value of the procInfraSA property.
     *
     * @return possible object is
     * {@link ProcInfraSA }
     */
    public ProcInfraSA getProcInfraSA() {
        return procInfraSA;
    }

    /**
     * Sets the value of the procInfraSA property.
     *
     * @param value allowed object is
     *              {@link ProcInfraSA }
     */
    public void setProcInfraSA(ProcInfraSA value) {
        this.procInfraSA = value;
    }

    public boolean isSetProcInfraSA() {
        return (this.procInfraSA != null);
    }
    ...
    public static class ProcInfraSA
            implements XML {

        @XmlElement(required = true)
        protected String nProtDTe;
        @XmlElement(required = true)
        protected String dhProt;

        /**
         * Gets the value of the nProtDTe property.
         *
         * @return possible object is
         * {@link String }
         */
        public String getNProtDTe() {
            return nProtDTe;
        }

        /**
         * Sets the value of the nProtDTe property.
         *
         * @param value allowed object is
         *              {@link String }
         */
        public void setNProtDTe(String value) {
            this.nProtDTe = value;
        }

        public boolean isSetNProtDTe() {
            return (this.nProtDTe != null);
        }

        /**
         * Gets the value of the dhProt property.
         *
         * @return possible object is
         * {@link String }
         */
        public String getDhProt() {
            return dhProt;
        }

        /**
         * Sets the value of the dhProt property.
         *
         * @param value allowed object is
         *              {@link String }
         */
        public void setDhProt(String value) {
            this.dhProt = value;
        }

        public boolean isSetDhProt() {
            return (this.dhProt != null);
        }
