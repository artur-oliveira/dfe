 ...
 * 
 */
@WebServiceClient(name = "CTeStatusServicoV4", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CteStatusServico", wsdlLocation = "https://cte.fazenda.mg.gov.br/cte/services/CTeStatusServicoV4?wsdl")
    ...
    extends Service
{
    ...
    private static final QName CTESTATUSSERVICOV4_QNAME = new QName("http://www.portalfiscal.inf.br/cte/wsdl/CteStatusServico", "CTeStatusServicoV4");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://cte.fazenda.mg.gov.br/cte/services/CTeStatusServicoV4?wsdl");
     ...
     * 
     * @return
     *     returns CTeStatusServicoV4Soap12
     */
    @WebEndpoint(name = "CTeStatusServicoV4Soap12")
    public CTeStatusServicoV4Soap12 getCTeStatusServicoV4Soap12() {
        return super.getPort(new QName("http://www.portalfiscal.inf.br/cte/wsdl/CteStatusServico", "CTeStatusServicoV4Soap12"), CTeStatusServicoV4Soap12.class);
    }
    ...
    public CTeStatusServicoV4Soap12 getCTeStatusServicoV4Soap12(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.portalfiscal.inf.br/cte/wsdl/CteStatusServico", "CTeStatusServicoV4Soap12"), CTeStatusServicoV4Soap12.class, features);
    }
