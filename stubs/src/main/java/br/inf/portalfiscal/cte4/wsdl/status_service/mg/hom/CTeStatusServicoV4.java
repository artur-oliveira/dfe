 ...
 * 
 */
@WebServiceClient(name = "CTeStatusServicoV4", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CteStatusServico", wsdlLocation = "https://hcte.fazenda.mg.gov.br/cte/services/CTeStatusServicoV4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://hcte.fazenda.mg.gov.br/cte/services/CTeStatusServicoV4?wsdl");
