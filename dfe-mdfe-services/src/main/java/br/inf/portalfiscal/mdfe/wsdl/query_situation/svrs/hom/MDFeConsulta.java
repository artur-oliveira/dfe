 ...
 *
 */
@WebServiceClient(name = "MDFeConsulta", targetNamespace = "http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeConsulta", wsdlLocation = "https://mdfe-homologacao.svrs.rs.gov.br/ws/MDFeConsulta/MDFeConsulta.asmx?wsdl")
public class MDFeConsulta
    ...
    static {
        ...
        try {
            url = URI.create("https://mdfe-homologacao.svrs.rs.gov.br/ws/MDFeConsulta/MDFeConsulta.asmx?wsdl").toURL();
