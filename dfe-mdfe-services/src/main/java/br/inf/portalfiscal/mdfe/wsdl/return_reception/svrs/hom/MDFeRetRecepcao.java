 ...
 *
 */
@WebServiceClient(name = "MDFeRetRecepcao", targetNamespace = "http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRetRecepcao", wsdlLocation = "https://mdfe-homologacao.svrs.rs.gov.br/ws/MDFeRetRecepcao/MDFeRetRecepcao.asmx?wsdl")
public class MDFeRetRecepcao
    ...
    static {
        ...
        try {
            url = URI.create("https://mdfe-homologacao.svrs.rs.gov.br/ws/MDFeRetRecepcao/MDFeRetRecepcao.asmx?wsdl").toURL();
