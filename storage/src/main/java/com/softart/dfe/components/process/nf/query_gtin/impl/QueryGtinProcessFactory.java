...
public abstract class QueryGtinProcessFactory implements ProcessFactory<TConsGTIN, TRetConsGTIN> {
    ...
    public static QueryGtinProcessFactory s3() {
        return RequireUtils.nonNull(Holder.S3, "com.softart.dfe.components.process.nf.query_gtin.manifestation.s3.S3StoreFactory is not initialized");
    }
    ...
    private final static class Holder {
        ...
        private final static QueryGtinProcessFactory S3 = ReflectionUtils.safeNewInstance(S3StoreFactory.class);
    }
}
