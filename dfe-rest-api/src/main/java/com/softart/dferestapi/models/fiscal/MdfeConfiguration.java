...
public final class MdfeConfiguration {
    ...
    @Builder.Default
    @Min(0)
    @Column(name = "mdfe_serie", columnDefinition = "UNSIGNED TINYINT DEFAULT 0", nullable = false)
    private Short serie = 0;

    @Builder.Default
    @NotNull
    @Min(0)
    @Column(name = "mdfe_number_production", columnDefinition = "UNSIGNED SMALLINT DEFAULT 0", nullable = false)
    private Integer numberProduction = 0;

    @Builder.Default
    @NotNull
    @Min(0)
    @Column(name = "mdfe_number_homologation", columnDefinition = "UNSIGNED SMALLINT DEFAULT 0", nullable = false)
