...
public final class CteConfiguration {
    ...
    @Builder.Default
    @Min(0)
    @Column(name = "cte_serie", columnDefinition = "TINYINT UNSIGNED DEFAULT 0", nullable = false)
    private Short serie = 0;

    @Builder.Default
    @NotNull
    @Min(0)
    @Column(name = "cte_number_production", columnDefinition = "INT UNSIGNED DEFAULT 0", nullable = false)
    private Integer numberProduction = 0;

    @Builder.Default
    @NotNull
    @Min(0)
    @Column(name = "cte_number_homologation", columnDefinition = "INT UNSIGNED DEFAULT 0", nullable = false)
