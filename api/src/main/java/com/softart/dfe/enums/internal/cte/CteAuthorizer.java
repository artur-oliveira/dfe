...
public enum CteAuthorizer implements CteURL, AllowUF {
    ...
    SVRS {
        private Collection<UF> ufs() {
            return Arrays.asList(UF.AC, UF.AL, UF.AM, UF.BA, UF.CE, UF.DF, UF.ES, UF.GO, UF.MA, UF.PA, UF.PB, UF.PI, UF.RJ, UF.RN, UF.RO, UF.RS, UF.SC, UF.SE, UF.TO);
        }
