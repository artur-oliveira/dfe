...
public final class CteMtService extends CteAnService {
    ...
    public <T extends SefazRequest<TCTe, TRetCTe>> Pair<TCTe, TRetCTe> receptionSync(T data) throws SecurityException, ValidationException, ProcessException {
        ...
        if (data.getConfig().production()) {
            ...
            data.getConfigureProvider().configure(ProviderConfig.builder().port((BindingProvider) ws).config(data.getConfig()).overridePortAddress("https://cte.sefaz.mt.gov.br/ctews2/services/CteRecepcaoSinc").build());
            ...
            data.getConfigureProvider().configure(ProviderConfig.builder().port((BindingProvider) ws).config(data.getConfig()).overridePortAddress("https://homologacao.sefaz.mt.gov.br/ctews2/services/CteRecepcaoSinc").build());
