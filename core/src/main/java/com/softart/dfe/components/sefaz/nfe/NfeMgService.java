...
public final class NfeMgService extends NfeAnService {
    ...
    public <T extends SefazRequest<TConsCad, TRetConsCad>> Pair<TConsCad, TRetConsCad> queryRegister(T data) throws SecurityException, ValidationException, ProcessException {
        ...
        if (data.getConfig().production()) {
            ...
            br.inf.portalfiscal.nfe.wsdl.query_register.mg.prod.ConsultaCadastro4Result resultMsg = ws.consultaCadastro(msg);
            ...
            br.inf.portalfiscal.nfe.wsdl.query_register.mg.hom.ConsultaCadastro4Result resultMsg = ws.consultaCadastro(msg);
