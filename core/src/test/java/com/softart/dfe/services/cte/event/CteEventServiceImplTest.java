...
class CteEventServiceImplTest {
    ...
    void testCancelWithEnviromentHomologationAndAuthorizerMt() throws Exception {
        ...
        DfeUncheckedException exception = assertThrows(DfeUncheckedException.class, () -> {
            service.cancel("51230511520224000140999999999999999999999999", "999999999999999");
        });

        assertEquals("Serviço de eventos não disponível no ambiente de homologação", exception.getMessage());
    }
    ...
    void testCorrectionLetterWithEnviromentHomologationAndAuthorizerMt() throws Exception {
        ...
        DfeUncheckedException exception = assertThrows(DfeUncheckedException.class, () -> {
            service.correctionLetter("51230511520224000140999999999999999999999999", Collections.singletonList(
                    CteCorrectionLetter.InfEvento.DetEvento.EvCCeCTe.InfCorrecao
                            .builder()
                            .campoAlterado("xNome")
                            .grupoAlterado("emit")
