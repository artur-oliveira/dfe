 ...
 * generated in the br.inf.portalfiscal.mdfe.wsdl.distribution.svrs.prod package. 
...
public class ObjectFactory {
    ...
    private final static QName _MdfeCabecMsg_QNAME = new QName("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeDistribuicaoDFe", "mdfeCabecMsg");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.inf.portalfiscal.mdfe.wsdl.distribution.svrs.prod
     * 
     */
