 ...
 *                           &lt;attribute name="NSU" type="{http://www.portalfiscal.inf.br/nfe}TNSU" /&gt;
    ...
    implements XML
{
    ...
    protected TRetDistDFeInt.LoteDistDFeInt loteDistDFeInt;
        ...
        implements XML
    {
        ...
        public List<TRetDistDFeInt.LoteDistDFeInt.DocZip> getDocZip() {
            if (docZip == null) {
                docZip = new ArrayList<TRetDistDFeInt.LoteDistDFeInt.DocZip>();
            }
            return this.docZip;
        }
