...
public class CteReturnQuerySituation implements DFObject, XMLAdapter<CteReturnQuerySituation, TRetConsSitCTe> {
    ...
    @AllArgsConstructor
    @NoArgsConstructor
    public static class ProtCTe implements DFObject, XMLAdapter<ProtCTe, br.inf.portalfiscal.cte.send.ProtCTeAny> {
        ...
        @Override
        public br.inf.portalfiscal.cte.send.ProtCTeAny toObject() {
            br.inf.portalfiscal.cte.send.ProtCTeAny protCTe = new br.inf.portalfiscal.cte.send.ProtCTeAny();
            protCTe.setVersao(getVersao());
            return protCTe;
        }

        @Override
        public ProtCTe fromObject(br.inf.portalfiscal.cte.send.ProtCTeAny o) {
