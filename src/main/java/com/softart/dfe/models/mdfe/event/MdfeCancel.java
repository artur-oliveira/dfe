...
@NoArgsConstructor
@Builder
public final class MdfeCancel implements DFObject, XMLAdapter<MdfeCancel, TEvento> {
    private InfEvento infEvento;

    @Builder.Default
    private String versao = MdfeEventVersion.getDefault().getVersion();

    public static MdfeCancel build(String accessKey, String protocol, String motive, String sequence, MdfeConfig conf) {
        return MdfeCancel
                .builder()
                .infEvento(InfEvento
                        .builder()
    ...
    public static final class InfEvento implements DFObject, XMLAdapter<InfEvento, TEvento.InfEvento> {
        ...
        @Builder.Default
        private String tpEvento = MdfeEvent.CANCEL.getCode();
        private String nSeqEvento;
        private DetEvento detEvento;
        private String id;

        @Override
        public br.inf.portalfiscal.mdfe.classes.TEvento.InfEvento toObject() {
        ...
        public static final class DetEvento implements DFObject, XMLAdapter<DetEvento, TEvento.InfEvento.DetEvento> {
            ...
            public TEvento.InfEvento.DetEvento toObject() {
                br.inf.portalfiscal.mdfe.classes.TEvento.InfEvento.DetEvento evento = new br.inf.portalfiscal.mdfe.classes.TEvento.InfEvento.DetEvento();
            ...
            public DetEvento fromObject(TEvento.InfEvento.DetEvento o) {
                ...
                evento.setEvent(EvCancMDFe.builder().build().fromObject(MdfeUnmarshaller.evCancMDFe(o.getAny()).getValue()));
                return evento;
            }
            ...
            @NoArgsConstructor
            @Builder
            public static final class EvCancMDFe implements DFObject, XMLAdapter<EvCancMDFe, br.inf.portalfiscal.mdfe.classes.EvCancMDFe> {
                @Builder.Default
                private String descEvento = MdfeEvent.CANCEL.getDescription();
