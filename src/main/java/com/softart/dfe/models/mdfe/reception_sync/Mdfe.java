...
public final class Mdfe implements DFObject, XMLAdapter<Mdfe, TMDFe> {
    ...
    @AllArgsConstructor
    @NoArgsConstructor
    public static final class InfMDFe implements DFObject, XMLAdapter<InfMDFe, br.inf.portalfiscal.mdfe.classes.TMDFe.InfMDFe> {
        private Ide ide;
        private Emit emit;
        ...
        public static final class InfModal implements DFObject, XMLAdapter<InfModal, TMDFe.InfMDFe.InfModal> {
            ...
            public InfModal fromObject(TMDFe.InfMDFe.InfModal o) {
                ...
                if (el instanceof br.inf.portalfiscal.mdfe.classes.Rodo) {
                    setRodo(InfModal.Rodo.builder().build().fromObject((br.inf.portalfiscal.mdfe.classes.Rodo) el));
                } else if (el instanceof br.inf.portalfiscal.mdfe.classes.Aereo) {
                    setAereo(InfModal.Aereo.builder().build().fromObject((br.inf.portalfiscal.mdfe.classes.Aereo) el));
                } else if (el instanceof br.inf.portalfiscal.mdfe.classes.Aquav) {
                    setAquav(InfModal.Aquav.builder().build().fromObject((br.inf.portalfiscal.mdfe.classes.Aquav) el));
                } else if (el instanceof br.inf.portalfiscal.mdfe.classes.Ferrov) {
                    setFerrov(InfModal.Ferrov.builder().build().fromObject((br.inf.portalfiscal.mdfe.classes.Ferrov) el));
                }
