...
public abstract class KeyStoreFactory implements KeyStoreInfo {
    ...
    public static KeyStoreFactory getInstance() throws CertificateException {
        return getInstance(RequireUtils.nonNull(System.getProperty("com.softart.certificate.path"), "The path of certificate must be set with property com.softart.certificate.path"), RequireUtils.nonNull(System.getProperty("com.softart.certificate.password"), "The password of default certificate must be set with property com.softart.certificate.password"));
    }
