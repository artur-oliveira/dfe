...
public final class NfMarshaller {
    ...
    public static String inutNfe(br.inf.portalfiscal.nfe.send.TInutNFe tInutNFe) {
        try {
            javax.xml.bind.Marshaller marshaller = NfContextFactory.getInstance().getNfeSendContext().createMarshaller();
            StringWriter sw = new StringWriter();
            marshaller.marshal(new br.inf.portalfiscal.nfe.send.ObjectFactory().createInutNFe(tInutNFe), sw);
            return XMLStringUtils.cleanNamespace(sw.toString());
        } catch (JAXBException e) {
            throw new MarshallException(e);
        }
    ...
    public static String retInutNfe(TRetInutNFe response) {
        try {
            javax.xml.bind.Marshaller marshaller = NfContextFactory.getInstance().getNfeSendContext().createMarshaller();
            StringWriter sw = new StringWriter();
            marshaller.marshal(new br.inf.portalfiscal.nfe.send.ObjectFactory().createRetInutNFe(response), sw);
            return XMLStringUtils.cleanNamespace(sw.toString());
        } catch (JAXBException e) {
            throw new MarshallException(e);
        }
    ...
    public static String procInutNfe(TProcInutNFe procInut) {
        try {
            javax.xml.bind.Marshaller marshaller = NfContextFactory.getInstance().getNfeSendContext().createMarshaller();
            StringWriter sw = new StringWriter();
            marshaller.marshal(new br.inf.portalfiscal.nfe.send.ObjectFactory().createProcInutNFe(procInut), sw);
            return XMLStringUtils.cleanNamespace(sw.toString());
        } catch (JAXBException e) {
            throw new MarshallException(e);
        }
    ...
    public static String sendNfe(br.inf.portalfiscal.nfe.send.TEnviNFe tEnviNFe) {
        try {
            javax.xml.bind.Marshaller marshaller = NfContextFactory.getInstance().getNfeSendContext().createMarshaller();
            StringWriter sw = new StringWriter();
            marshaller.marshal(new br.inf.portalfiscal.nfe.send.ObjectFactory().createEnviNFe(tEnviNFe), sw);
            return XMLStringUtils.cleanNamespace(sw.toString());
        } catch (JAXBException e) {
            throw new MarshallException(e);
        }
    ...
    public static String procNfe(br.inf.portalfiscal.nfe.send.TNfeProc proc) {
        try {
            javax.xml.bind.Marshaller marshaller = NfContextFactory.getInstance().getNfeSendContext().createMarshaller();
            StringWriter sw = new StringWriter();
            marshaller.marshal(new br.inf.portalfiscal.nfe.send.ObjectFactory().createNfeProc(proc), sw);
            return XMLStringUtils.cleanNamespace(sw.toString());
        } catch (JAXBException e) {
            throw new MarshallException(e);
        }
    ...
    public static String nfe(br.inf.portalfiscal.nfe.send.TNFe tnFe) {
        try {
            javax.xml.bind.Marshaller marshaller = NfContextFactory.getInstance().getNfeSendContext().createMarshaller();
            StringWriter sw = new StringWriter();
            marshaller.marshal(new br.inf.portalfiscal.nfe.send.ObjectFactory().createNFe(tnFe), sw);
            return XMLStringUtils.cleanNamespace(sw.toString());
        } catch (JAXBException e) {
            throw new MarshallException(e);
        }
    ...
    public static String retEnviNfe(TRetEnviNFe retEnvi) {
        try {
            javax.xml.bind.Marshaller marshaller = NfContextFactory.getInstance().getNfeSendContext().createMarshaller();
            StringWriter sw = new StringWriter();
            marshaller.marshal(new br.inf.portalfiscal.nfe.send.ObjectFactory().createRetEnviNFe(retEnvi), sw);
            return XMLStringUtils.cleanNamespace(sw.toString());
        } catch (JAXBException e) {
            throw new MarshallException(e);
        }
    ...
    public static String queryReceiptNfe(TConsReciNFe tConsReciNFe) {
        try {
            javax.xml.bind.Marshaller marshaller = NfContextFactory.getInstance().getNfeSendContext().createMarshaller();
            StringWriter sw = new StringWriter();
            marshaller.marshal(new br.inf.portalfiscal.nfe.send.ObjectFactory().createConsReciNFe(tConsReciNFe), sw);
            return XMLStringUtils.cleanNamespace(sw.toString());
        } catch (JAXBException e) {
            throw new MarshallException(e);
        }
    ...
    public static String retQueryReceiptNfe(TRetConsReciNFe tRetConsReciNFe) {
        try {
            javax.xml.bind.Marshaller marshaller = NfContextFactory.getInstance().getNfeSendContext().createMarshaller();
            StringWriter sw = new StringWriter();
            marshaller.marshal(new br.inf.portalfiscal.nfe.send.ObjectFactory().createRetConsReciNFe(tRetConsReciNFe), sw);
            return XMLStringUtils.cleanNamespace(sw.toString());
        } catch (JAXBException e) {
            throw new MarshallException(e);
        }
    ...
    public static String queryProcotolNfe(TConsSitNFe tConsSitNFe) {
        try {
            javax.xml.bind.Marshaller marshaller = NfContextFactory.getInstance().getNfeSendContext().createMarshaller();
            StringWriter sw = new StringWriter();
            marshaller.marshal(new br.inf.portalfiscal.nfe.send.ObjectFactory().createConsSitNFe(tConsSitNFe), sw);
            return XMLStringUtils.cleanNamespace(sw.toString());
        } catch (JAXBException e) {
            throw new MarshallException(e);
        }
    ...
    public static String queryStatusServiceNfe(TConsStatServ tConsStatServ) {
        try {
            javax.xml.bind.Marshaller marshaller = NfContextFactory.getInstance().getNfeSendContext().createMarshaller();
            StringWriter sw = new StringWriter();
            marshaller.marshal(new br.inf.portalfiscal.nfe.send.ObjectFactory().createConsStatServ(tConsStatServ), sw);
            return XMLStringUtils.cleanNamespace(sw.toString());
        } catch (JAXBException e) {
            throw new MarshallException(e);
        }
    ...
    public static String retQueryStatusServiceNfe(TRetConsStatServ tRetConsReciNFe) {
        try {
            javax.xml.bind.Marshaller marshaller = NfContextFactory.getInstance().getNfeSendContext().createMarshaller();
            StringWriter sw = new StringWriter();
            marshaller.marshal(new br.inf.portalfiscal.nfe.send.ObjectFactory().createRetConsStatServ(tRetConsReciNFe), sw);
            return XMLStringUtils.cleanNamespace(sw.toString());
        } catch (JAXBException e) {
            throw new MarshallException(e);
        }
    ...
    public static String retQueryProtocolNfe(TRetConsSitNFe tRetConsReciNFe) {
        try {
            javax.xml.bind.Marshaller marshaller = NfContextFactory.getInstance().getNfeSendContext().createMarshaller();
            StringWriter sw = new StringWriter();
            marshaller.marshal(new br.inf.portalfiscal.nfe.send.ObjectFactory().createRetConsSitNFe(tRetConsReciNFe), sw);
            return XMLStringUtils.cleanNamespace(sw.toString());
        } catch (JAXBException e) {
            throw new MarshallException(e);
        }
