...
public final class NfceSpService implements NfceService {
    ...
    public <T extends SefazRequest<TEnviNFe, TRetEnviNFe>> Pair<TEnviNFe, TRetEnviNFe> authorize(T data) throws SecurityException, ValidationException, ProcessException {
        ...
        if (data.getConfig().production()) {
            ...
            br.inf.portalfiscal.nfe.wsdl.authorization.sp.nfce.prod.NfeDadosMsg msg = new br.inf.portalfiscal.nfe.wsdl.authorization.sp.nfce.prod.NfeDadosMsg();
            msg.getContent().add(envio);

            br.inf.portalfiscal.nfe.wsdl.authorization.sp.nfce.prod.NfeResultMsg resultMsg = ws.nfeAutorizacaoLote(msg);
            ...
            br.inf.portalfiscal.nfe.wsdl.authorization.sp.nfce.hom.NfeDadosMsg msg = new br.inf.portalfiscal.nfe.wsdl.authorization.sp.nfce.hom.NfeDadosMsg();
            msg.getContent().add(envio);

            br.inf.portalfiscal.nfe.wsdl.authorization.sp.nfce.hom.NfeResultMsg resultMsg = ws.nfeAutorizacaoLote(msg);
