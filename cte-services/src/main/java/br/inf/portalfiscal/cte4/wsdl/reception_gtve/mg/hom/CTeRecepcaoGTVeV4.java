 ...
 * 
 */
@WebServiceClient(name = "CTeRecepcaoGTVeV4", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoGTVe", wsdlLocation = "https://hcte.fazenda.mg.gov.br/cte/services/CTeRecepcaoGTVeV4?wsdl")
    ...
    extends Service
{
    ...
    private static final QName CTERECEPCAOGTVEV4_QNAME = new QName("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoGTVe", "CTeRecepcaoGTVeV4");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://hcte.fazenda.mg.gov.br/cte/services/CTeRecepcaoGTVeV4?wsdl");
    ...
    public CTeRecepcaoGTVeV4Soap12 getCTeRecepcaoGTVeV4Soap12() {
        return super.getPort(new QName("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoGTVe", "CTeRecepcaoGTVeV4Soap12"), CTeRecepcaoGTVeV4Soap12.class);
    }
    ...
    public CTeRecepcaoGTVeV4Soap12 getCTeRecepcaoGTVeV4Soap12(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoGTVe", "CTeRecepcaoGTVeV4Soap12"), CTeRecepcaoGTVeV4Soap12.class, features);
    }
