 ...
 * 
 */
@WebServiceClient(name = "CTeStatusServicoV4", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CTeStatusServicoV4", wsdlLocation = "https://producao.cte.ms.gov.br/ws/CTeStatusServicoV4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://producao.cte.ms.gov.br/ws/CTeStatusServicoV4?wsdl");
