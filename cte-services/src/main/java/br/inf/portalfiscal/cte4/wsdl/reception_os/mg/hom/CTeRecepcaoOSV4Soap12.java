 ...
 * 
 */
@WebService(name = "CTeRecepcaoOSV4Soap12", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoOS")
...
public interface CTeRecepcaoOSV4Soap12 {
     ...
     * @param cteDadosMsg
     * @return
     *     returns br.inf.portalfiscal.cte4.wsdl.reception_os.mg.hom.CteRecepcaoOSResult
     */
    ...
    @Action(input = "http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoOS/cteRecepcaoOS", output = "http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoOS/CTeRecepcaoOSV4Soap12/cteRecepcaoOSResponse")
