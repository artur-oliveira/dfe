 ...
 * 
 */
@WebServiceClient(name = "CTeRecepcaoEventoV4", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CTeRecepcaoEventoV4", wsdlLocation = "https://homologacao.cte.fazenda.pr.gov.br/cte4/CTeRecepcaoEventoV4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://homologacao.cte.fazenda.pr.gov.br/cte4/CTeRecepcaoEventoV4?wsdl");
