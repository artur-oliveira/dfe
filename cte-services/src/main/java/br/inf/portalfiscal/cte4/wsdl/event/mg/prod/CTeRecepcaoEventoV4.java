 ...
 * 
 */
@WebServiceClient(name = "CTeRecepcaoEventoV4", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoEvento", wsdlLocation = "https://cte.fazenda.mg.gov.br/cte/services/CTeRecepcaoEventoV4?wsdl")
    ...
    extends Service
{
    ...
    private static final QName CTERECEPCAOEVENTOV4_QNAME = new QName("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoEvento", "CTeRecepcaoEventoV4");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://cte.fazenda.mg.gov.br/cte/services/CTeRecepcaoEventoV4?wsdl");
    ...
    public CTeRecepcaoEventoV4Soap12 getCTeRecepcaoEventoV4Soap12() {
        return super.getPort(new QName("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoEvento", "CTeRecepcaoEventoV4Soap12"), CTeRecepcaoEventoV4Soap12.class);
    }
    ...
    public CTeRecepcaoEventoV4Soap12 getCTeRecepcaoEventoV4Soap12(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoEvento", "CTeRecepcaoEventoV4Soap12"), CTeRecepcaoEventoV4Soap12.class, features);
    }
