 ...
 * 
 */
@WebServiceClient(name = "CTeRecepcaoGTVeV4", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoGTVe", wsdlLocation = "https://cte.fazenda.mg.gov.br/cte/services/CTeRecepcaoGTVeV4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://cte.fazenda.mg.gov.br/cte/services/CTeRecepcaoGTVeV4?wsdl");
