 ...
 * 
 */
@WebServiceClient(name = "CTeStatusServicoV4", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CTeStatusServicoV4", wsdlLocation = "https://homologacao.cte.fazenda.pr.gov.br/cte4/CTeStatusServicoV4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://homologacao.cte.fazenda.pr.gov.br/cte4/CTeStatusServicoV4?wsdl");
