 ...
 */
@WebServiceClient(name = "CteRecepcao", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcao", wsdlLocation = "https://homologacao.cte.ms.gov.br/ws/CteRecepcao?wsdl")
public class CteRecepcao
    ...
    static {
        ...
        try {
            url = new URL("https://homologacao.cte.ms.gov.br/ws/CteRecepcao?wsdl");
