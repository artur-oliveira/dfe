 ...
 */
@WebServiceClient(name = "CteInutilizacao", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CteInutilizacao", wsdlLocation = "https://homologacao.cte.ms.gov.br/ws/CteInutilizacao?wsdl")
public class CteInutilizacao
    ...
    static {
        ...
        try {
            url = new URL("https://homologacao.cte.ms.gov.br/ws/CteInutilizacao?wsdl");
