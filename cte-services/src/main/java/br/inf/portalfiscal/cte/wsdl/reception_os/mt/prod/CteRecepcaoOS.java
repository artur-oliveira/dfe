 ...
 */
@WebServiceClient(name = "CteRecepcaoOS", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoOS", wsdlLocation = "https://cte.sefaz.mt.gov.br/ctews/services/CteRecepcaoOS?wsdl")
public class CteRecepcaoOS
    ...
    static {
        ...
        try {
            url = new URL("https://cte.sefaz.mt.gov.br/ctews/services/CteRecepcaoOS?wsdl");
