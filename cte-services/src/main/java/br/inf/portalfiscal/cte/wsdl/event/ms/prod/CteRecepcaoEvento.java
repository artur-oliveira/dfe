 ...
 */
@WebServiceClient(name = "CteRecepcaoEvento", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoEvento", wsdlLocation = "https://producao.cte.ms.gov.br/ws/CteRecepcaoEvento?wsdl")
public class CteRecepcaoEvento
    ...
    static {
        ...
        try {
            url = new URL("https://producao.cte.ms.gov.br/ws/CteRecepcaoEvento?wsdl");
