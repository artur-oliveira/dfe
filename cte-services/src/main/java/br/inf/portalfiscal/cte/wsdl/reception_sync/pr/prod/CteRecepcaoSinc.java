 ...
 */
@WebServiceClient(name = "CteRecepcaoSinc", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoSinc", wsdlLocation = "https://cte.fazenda.pr.gov.br/cte/CteRecepcaoSinc?wsdl")
public class CteRecepcaoSinc
    ...
    static {
        ...
        try {
            url = new URL("https://cte.fazenda.pr.gov.br/cte/CteRecepcaoSinc?wsdl");
