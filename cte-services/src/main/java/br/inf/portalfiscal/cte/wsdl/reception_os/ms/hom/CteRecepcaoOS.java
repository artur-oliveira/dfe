 ...
 */
@WebServiceClient(name = "CteRecepcaoOS", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoOS", wsdlLocation = "https://homologacao.cte.ms.gov.br/ws/CteRecepcaoOS?wsdl")
public class CteRecepcaoOS
    ...
    static {
        ...
        try {
            url = new URL("https://homologacao.cte.ms.gov.br/ws/CteRecepcaoOS?wsdl");
