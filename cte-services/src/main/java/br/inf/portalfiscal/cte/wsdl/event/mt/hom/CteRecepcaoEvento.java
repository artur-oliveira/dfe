 ...
 */
@WebServiceClient(name = "CteRecepcaoEvento", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoEvento", wsdlLocation = "https://homologacao.sefaz.mt.gov.br/ctews2/services/CteRecepcaoEvento?wsdl")
public class CteRecepcaoEvento
    ...
    static {
        ...
        try {
            url = new URL("https://homologacao.sefaz.mt.gov.br/ctews2/services/CteRecepcaoEvento?wsdl");
