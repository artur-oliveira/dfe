 ...
 */
@WebServiceClient(name = "CteInutilizacao", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CteInutilizacao", wsdlLocation = "https://hcte.fazenda.mg.gov.br/cte/services/CteInutilizacao?wsdl")
public class CteInutilizacao
    ...
    static {
        ...
        try {
            url = new URL("https://hcte.fazenda.mg.gov.br/cte/services/CteInutilizacao?wsdl");
