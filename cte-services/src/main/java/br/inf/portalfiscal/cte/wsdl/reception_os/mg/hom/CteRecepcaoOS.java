 ...
 */
@WebServiceClient(name = "CteRecepcaoOS", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoOS", wsdlLocation = "https://hcte.fazenda.mg.gov.br/cte/services/CteRecepcaoOS?wsdl")
public class CteRecepcaoOS
    ...
    static {
        ...
        try {
            url = new URL("https://hcte.fazenda.mg.gov.br/cte/services/CteRecepcaoOS?wsdl");
