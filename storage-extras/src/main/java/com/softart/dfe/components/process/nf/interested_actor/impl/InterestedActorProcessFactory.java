...
public abstract class InterestedActorProcessFactory implements ProcessFactory<TEnvEvento, TRetEnvEvento> {
    ...
    public static InterestedActorProcessFactory s3() {
        return RequireUtils.nonNull(Holder.S3, "com.softart.dfe.components.process.nf.interested_actor.impl.s3.S3StoreFactory is not initialized");
    }
    ...
    private final static class Holder {
        ...
        private final static InterestedActorProcessFactory S3 = ReflectionUtils.safeNewInstance(S3StoreFactory.class);
    }
