...
import com.softart.dfe.components.process.nf.inut.impl.s3.S3StoreFactory;
...
public abstract class InutilizationProcessFactory implements ProcessFactory<TInutNFe, TRetInutNFe> {
    ...
    public static InutilizationProcessFactory s3() {
        return RequireUtils.nonNull(Holder.S3, "com.softart.dfe.components.process.nf.inut.impl.s3.S3StoreFactory is not initialized");
    }
    ...
    private final static class Holder {
        ...
        private final static InutilizationProcessFactory S3 = ReflectionUtils.safeNewInstance(S3StoreFactory.class);
    }
}
