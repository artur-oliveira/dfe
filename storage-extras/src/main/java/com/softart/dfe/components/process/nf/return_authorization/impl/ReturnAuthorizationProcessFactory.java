...
public abstract class ReturnAuthorizationProcessFactory implements ProcessFactory<TConsReciNFe, TRetConsReciNFe> {
    ...
    public static ReturnAuthorizationProcessFactory s3() {
        return RequireUtils.nonNull(Holder.S3, "com.softart.dfe.components.process.nf.return_authorization.s3.S3StoreFactory is not initialized");
    }
    ...
    private final static class Holder {
        ...
        private final static ReturnAuthorizationProcessFactory S3 = ReflectionUtils.safeNewInstance(S3StoreFactory.class);
    }
}
