...
public abstract class CancelProcessFactory implements ProcessFactory<TEnvEvento, TRetEnvEvento> {
    ...
    public static CancelProcessFactory s3() {
        return RequireUtils.nonNull(Holder.S3, "com.softart.dfe.components.process.nf.cancel.impl.s3.S3StoreFactory is not initialized");
    }
    ...
    private final static class Holder {
        ...
        private final static CancelProcessFactory S3 = ReflectionUtils.safeNewInstance(S3StoreFactory.class);
    }
}
