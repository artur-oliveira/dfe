...
public abstract class DistributionProcessFactory implements ProcessFactory<TDistDFeInt, TRetDistDFeInt> {
    ...
    public static DistributionProcessFactory s3() {
        return RequireUtils.nonNull(Holder.S3, "com.softart.dfe.components.process.nf.distribution.impl.s3.S3StoreFactory is not initialized");
    }
    ...
    private final static class Holder {
        ...
        private final static DistributionProcessFactory S3 = ReflectionUtils.safeNewInstance(S3StoreFactory.class);
    }
}
