...
public abstract class AuthorizationProcessFactory implements ProcessFactory<TEnviNFe, TRetEnviNFe> {
    ...
    public static AuthorizationProcessFactory s3() {
        return RequireUtils.nonNull(Holder.S3, "com.softart.dfe.components.process.nf.authorization.impl.s3.S3StoreFactory is not initialized");
    }
    ...
    private final static class Holder {
        ...
        private final static AuthorizationProcessFactory S3 = ReflectionUtils.safeNewInstance(S3StoreFactory.class);
    }
}
