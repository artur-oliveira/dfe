...
public abstract class NfProcess implements NfProcessService {
    ...
    public static NfProcess getInstance() {
        switch (DEFAULT) {
            case "s3":
                return RequireUtils.nonNull(Holder.S3, "com.softart.dfe.models.internal.process.S3NfProcess has not been initialized");
            case "default":
            default:
    ...
    static final class Holder {
        ...
        final static NfProcess S3 = ReflectionUtils.safeNewInstance(S3NfProcess.class);
    }
}
